<?php
	...
	$url='http://api.geonames.org/countryCodeJSON?formatted=true&lat=' . $_REQUEST['lat'] . '&lng=' . $_REQUEST['lng'] . '&username=khushi&style=full';

	//http://api.geonames.org/countryCodeJSON?formatted=true&lat=47.10&lng=10.2&username=khushi&style=full';
